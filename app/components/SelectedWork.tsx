              ...
              <div className="pl-7 sm:pl-8">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {project.tech.map((t) => (
                    <span
                      key={t.name}
                      className="inline-flex items-center gap-1.5 rounded-md bg-white/60 border border-[#161616]/10 px-2.5 py-1 text-[11px] font-medium tracking-tight text-[#161616] transition-colors group-hover:border-[#161616]/30"
                    >
                      {t.icon && (
                ...
                <div className="mt-3.5 flex items-center gap-1">
                  ...
                  <span className="text-[#161616]/40 transition-all duration-200 -translate-x-1 group-hover:translate-x-1 group-hover:text-[#161616]">
                    →
                  </span>
                </div>
              </div>
